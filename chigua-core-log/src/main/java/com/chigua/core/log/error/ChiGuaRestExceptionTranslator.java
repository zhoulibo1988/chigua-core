...
import com.chigua.core.log.exception.SecureException;
import com.chigua.core.log.exception.ServiceException;
...
import com.chigua.core.tool.utils.UrlUtil;
 ...
 * ClassName: com.chigua.core.log.error.ChiGuaRestExceptionTranslator
 *
...
public class ChiGuaRestExceptionTranslator {
    ...
    public R handleError(Throwable e) {
        ...
        if("Bad credentials".equals(e.getMessage())){
            return R.fail(ResultCode.INTERNAL_SERVER_ERROR, "密码错误或者密码为空");
        }else{
