...
package com.chigua.core.log.logger;

import com.chigua.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class ChiGuaLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": ChiGuaLogger init success!");
	}
